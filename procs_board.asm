...
.data
key_array:	.word	0x15, 0x1D, 0x24, 0x1C, 0x1B, 0x23, 0x1A, 0x22, 0x21   	# define as many keycodes here as you need
num_keys:	.word	9				# put the length of the key_array here
